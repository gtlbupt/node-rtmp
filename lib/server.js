...
NetConnection.prototype.onConnect = function NetConnOnConnect(args){
    ...
    debug("Function[NetConnection.onConnect] enter, clientId[%s]", this.clientId);
    var O   = args[2];
    ...
    debug("Function[NetConnection.onConnect] leave, clientId[%s]", this.clientId);
};
...
NetConnection.prototype.onCreateStream = function (args){
    debug('Function[NetConnection.createStream] enter, clientId[%s]', this.clientId);
